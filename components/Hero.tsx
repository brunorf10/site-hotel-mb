  ...
  return (
    <section className="relative h-[85vh] w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl">
        ...
        >
          Onde o Luxo Encontra a <span className="italic">Tranquilidade do Sertão</span>
        </motion.h1>
        <motion.div 
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce opacity-70 cursor-pointer" onClick={() => scrollToSection('galeria')}>
        <span className="text-white text-xs uppercase tracking-widest">Descubra mais</span>
